...
public static double classification(FileReader testfr)
{
	...
	try {
		outr = new BufferedReader(new FileReader(dataDirPath+"/"+"output"));
 ...
 */
{
	...
	try {
		hos = new FileInputStream(dataDirPath+"/"+"hamdb");
		...
		FileInputStream spos = new FileInputStream(dataDirPath+"/"+"spamdb");
		...
		FileInputStream aros = new FileInputStream(dataDirPath+"/"+"arcdb");
		...
		FileReader stats = new FileReader(dataDirPath+"/"+"stats");
